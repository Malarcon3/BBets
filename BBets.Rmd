...
Brownlows profits are from 200 to 340.
...
I started at the class size value of 35 which was too high. I then tried using the size value of 20 and 25 which was too low. Then I tried 27 was closer but still too low. To manipulate the odds the class size needed to be 29 students with the bet being 2:1 to get Dr. J earnings to be zero.
